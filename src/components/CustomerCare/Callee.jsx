      ...
      {isReceivingCall && (
        <div className="flex flex-col items-center justify-center bg-gray-800 p-4">
          ...
          <div className="flex gap-4">
            <button onClick={answerCall} className="bg-green-500 p-2 rounded-lg">Answer</button>
            <button onClick={declineCall} className="bg-red-500 p-2 rounded-lg">Decline</button>
          </div>
        </div>
      )}
    </>
