        ...
        <div style="max-width: 600px; margin: 20px auto; background: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px;">
            ...
            <div style="padding: 20px; text-align: left;">
                ...
                <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.5;">
                    A new device signed in to your TaskTrackr account, <a href="mailto:${user.email}" style="color: #e50914; text-decoration: none;">${user.email}</a>.
                </p>
                ...
                <p style="margin-top: 20px; font-size: 16px;">If this was you or someone in your household, you can ignore this message.</p>
                <p style="font-size: 16px; margin-top: 20px;">If it was someone else, please remember that we only allow the people of our community to use this account.</p>
            ...
            <div style="background: #f4f4f4; text-align: center; padding: 10px; font-size: 14px; color: #888;">
                <p style="margin: 0;">&copy; 2024 TaskTrackr. All rights reserved.</p>
            </div>
        </div>
    </body>
    </html>
