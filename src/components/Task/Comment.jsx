...
const Comment = ({ status, Comments, taskId, fetchTaskDetails }) => {
  ...
  return (
    <div>
      ...
      <div className="comments-section p-4 example" style={{ height: "calc(100vh - 250px)", overflowY: "auto" }}>
      {Comments.length > 0 ? (
            ...
            <div className="z-20 w-full h-full overflow-hidden rounded-lg">
              <div className="flex justify-between items-center bg-gray-100 py-2 px-3">
                ...
                <div className="px-1 text-end flex items-center gap-2">
                  ...
                  <button
                    onClick={() => console.log(`Reply to ${commentData.id}`)}
              ...
              {commentData.type === 'comment' ? (
                <div className="px-3 py-2">
                  ...
                  {commentData.get_comment_image && commentData.get_comment_image.length > 0 && (
                    <div className="mt-1">
                      {commentData.get_comment_image.map((image, idx) => (
                        <a
                          key={idx}
                        ...
                        >
                          ...
                          >
                            <g fill="currentColor">
                              <path
                                d="M.002 3a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-12a2 2 0 0 1-2-2V3zm1 9v1a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V9.5l-3.777-1.947a.5.5 0 0 0-.577.093l-3.71 3.71l-2.66-1.772a.5.5 0 0 0-.63.062L1.002 12zm5-6.5a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0z"
                              />
                            </g>
                          </svg>
  ...
  <p className="text-sm text-gray-500 flex justify-center items-center h-full">No comments yet.</p>
)}
      ...
      {imageUrls.map((url, index) => (
        ...
        <div className="fixed bottom-4 right-0 p-2 mr-8 flex z-40 items-center">
          ...
          >
            ...
            <option value="2" selected={status === "2"}>Assigned For Review</option>
            <option value="3" selected={status === "3"}>Reviewed</option>
            <option value="4" selected={status === "4"}>Completed</option>
            <option value="5" selected={status === "5"}>Closed</option>
          </select>
